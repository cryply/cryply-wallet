...
public:
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Cryply debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("RPCConsole", "&Network Traffic", 0));
    } // retranslateUi
