...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 199X-YYYY The Cryply Core developers"));
        ...
        bitcoincopyrightLabel = new QLabel(AboutDialog);
        bitcoincopyrightLabel->setObjectName(QStringLiteral("bitcoincopyrightLabel"));
        bitcoincopyrightLabel->setCursor(QCursor(Qt::IBeamCursor));
        bitcoincopyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-2014 The Bitcoin Core developers"));
        bitcoincopyrightLabel->setTextFormat(Qt::RichText);
        bitcoincopyrightLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(bitcoincopyrightLabel);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Cryply Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Cryply Core</b> version", 0));
