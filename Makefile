...
pkgdatadir = $(datadir)/cryply
pkgincludedir = $(includedir)/cryply
pkglibdir = $(libdir)/cryply
pkglibexecdir = $(libexecdir)/cryply
...
am__aclocal_m4_deps = $(top_srcdir)/src/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/src/m4/ax_cxx_compile_stdcxx.m4 \
	$(top_srcdir)/src/m4/ax_cxx_compile_stdcxx_11.m4 \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/build-aux/missing COPYING INSTALL \
...
ACLOCAL = ${SHELL} /root/cryply/src/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_CPPFLAGS = 
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/cryply/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/cryply/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/cryply/src/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
COPYRIGHT_YEAR = 2018
CPP = gcc -E
CPPFLAGS =  -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -fPIC  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -g -O2 -g0 -O3 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/cryply/src/build-aux/missing makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
...
OBJCXXFLAGS = -g -O2 -g0 -O3 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC
OBJEXT = o
OTOOL = 
PACKAGE = cryply
PACKAGE_BUGREPORT = info@cryply.org
PACKAGE_NAME = Cryply Core
PACKAGE_STRING = Cryply Core 1.1.0
PACKAGE_TARNAME = cryply
PACKAGE_URL = 
...
abs_builddir = /root/cryply
abs_srcdir = /root/cryply
abs_top_builddir = /root/cryply
abs_top_srcdir = /root/cryply
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = 
...
install_sh = ${SHELL} /root/cryply/src/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/cryplyd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/cryply-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/cryply-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Cryply-Qt.app
OSX_DMG = Cryply-Qt.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Cryply-Qt
...
$(OSX_APP)/Contents/MacOS/Cryply-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#	$(INSTALL) contrib/macdeploy/DS_Store dist/.DS_Store
	...
	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "Cryply-Qt" -no-pad -r -apple -o $@ dist
